...
class SSLImputer:
    ...
    def build_model(self):
        ...
        self.cp = ModelCheckpoint(f"{self.directory_path}/cp_model.keras", save_best_only=True)
    ...
    def fit(self, data: pd.DataFrame):
        ...
        history = self.model.fit(train_data_scaled, train_data_scaled, validation_data=(val_data_scaled, val_data_scaled), epochs=20, verbose=1, callbacks=[self.cp])
